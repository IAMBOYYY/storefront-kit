...
**Free, open-source e-commerce store builder. Click "Use this template," configure it, ship it. No coding required.**
...
> ⚠️ **Don't fork this repo.** Use the green **"Use this template"** button instead. A fork stays linked to this repo and GitHub won't let you make it private — a template copy is a completely independent repo you can make private from the start.
...
1. Click **"Use this template"** → create a new repository (do **not** click "Fork" — forks can't be made private later, template copies can)
...
MIT — free to use, copy, modify, and build businesses with.
